...
* 根据提示，这次我们要取第三天的第二组等差数组偶数项，和今天的数组XOR,最后得到的10进制对照ASCII表。
* 详细表格如下:
...
* 总共6个数字。根据提示依然是XOR
* 根据提示需要取第三天的第一组等差数奇数项，和今天的数组进行XOR，最后得到的10进制对照ASCII表。
* 详细表格如下:

|第三天第一组|今日的数组|二进制XOR|十进制XOR|ASCII码|  
| :--------: | :--------: | :--------: | :--------: | :-------:|
|8|122|1000 XOR 01111010 = 01110010|8 XOR 122 = 114|r|
|22|115|00010110 XOR 01110011 = 01100101|22 XOR 115 = 101|e|
|36|104|00100100 XOR 01101000 = 01001100|36 XOR 104 = 76|L|
|50|91|00110010 XOR 01011011 = 01101001|50 XOR 91 = 105|i|
|64|37|01000000 XOR 00100101 = 01100101|64 XOR 37 = 101|e|
|78|40|01001110 XOR 00101000 = 01100110|78 XOR 40 = 102|f|

* 最终得到的ASCII码拼起来就是答案: reLief 解脱

## 第七天 关键词四
* 问题数组: 115 96 84 90 17
![关键词三](https://github.com/XMDS/YYD7RZD/blob/master/%E5%85%B3%E9%94%AE%E8%AF%8D%E5%9B%9B.jpg)
* 总共5个数字。根据提示依然是XOR
* 根据提示需要取第三天的第二组等差数偶数项，和今天的数组进行XOR，最后得到的10进制对照ASCII表。
* 详细表格如下:

|第三天第二组|今日的数组|二进制XOR|十进制XOR|ASCII码|  
| :--------: | :--------: | :--------: | :--------: | :-------:|
|3|115|11 XOR 01110011 = 01110000|3 XOR 115 = 112|p|
|15|96|1111 XOR 01100000 = 01101111|15 XOR 96 = 111|o|
|35|84|00100011 XOR 01010100 = 01110111|35 XOR 84 = 119|w|
|63|90|00111111 XOR 01011010 = 01100101|63 XOR 90 = 101|e|
|99|17|01100011 XOR 00010001 = 01110010|99 XOR 17 = 114|r|

* 最终得到的ASCII码拼起来就是答案: power 力量
